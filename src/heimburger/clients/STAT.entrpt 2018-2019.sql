...
WHERE (HISTO_FACTURES.DATEFAC BETWEEN to_date('01/01/2018', 'DD/MM/YYYY') AND to_date('31/08/2018', 'DD/MM/YYYY')
  ...
  AND HISTO_FACTURES.DATEFAC BETWEEN to_date('01/01/2018', 'DD/MM/YYYY') AND to_date('31/08/2019', 'DD/MM/YYYY')
  AND HISTO_FACTURES.TYPEDOC <> 'FP'
  AND BPCUSTOMER.TSCCOD_2 = '206'
UNION ALL
...
WHERE (ZCA_HEIMBURGER.DATEFAC BETWEEN to_date('01/01/2018', 'DD/MM/YYYY') AND to_date('31/08/2018', 'DD/MM/YYYY')
  ...
  AND ZCA_HEIMBURGER.DATEFAC BETWEEN to_date('01/01/2018', 'DD/MM/YYYY') AND to_date('31/08/2019', 'DD/MM/YYYY')
