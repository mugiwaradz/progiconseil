...
WHERE HISTO_FACTURES.DATEFAC BETWEEN to_date('01/01/2019', 'DD/MM/YYYY') AND to_date('31/05/2019', 'DD/MM/YYYY')
  AND HISTO_FACTURES.TYPEDOC <> 'FP'
  AND BPCUSTOMER.BPCPYR_0 = '003378'
UNION ALL
SELECT ZCA_HEIMBURGER.NUMFAC,
       ...
       ZCA_HEIMBURGER.FAMART4                                 AS FAMART,
...
WHERE ZCA_HEIMBURGER.DATEFAC BETWEEN to_date('06/01/2019', 'DD/MM/YYYY') AND to_date('31/08/2019', 'DD/MM/YYYY')
